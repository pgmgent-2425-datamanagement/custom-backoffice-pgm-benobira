...
<aside class="w-64 bg-indigo-600 text-white">
    <a href="/" class="block text-2xl font-semibold py-10 px-6">SeatSmart</a>
    <nav class="mt-0">
        <a href="/" class="flex items-center p-6 hover:bg-indigo-500">
        ...
        <a href="/reservations" class="flex items-center p-6 hover:bg-indigo-500">
            <svg class="h-6 w-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
            </svg>
            Reservations
        </a>
        <a href="/tables" class="flex items-center p-6 hover:bg-indigo-500">
        ...
        <a href="/menus" class="flex items-center p-6 hover:bg-indigo-500">
            <svg class="h-6 w-6 mr-3" xmlns="http://www.w3.org/2000/svg" width="800" height="800" fill="none" viewBox="0 0 24 24">
        ...
        <a href="/users" class="flex items-center p-6 hover:bg-indigo-500">
            <svg class="h-6 w-6 mr-3" xmlns="http://www.w3.org/2000/svg" width="800" height="800" fill="none" viewBox="0 0 24 24">
